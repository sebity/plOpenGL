...
:- module(plGL_defs, 
	  [
	   ...
	   kGL_LINE_BIT/1,
	   kGL_POLYGON_BIT/1,
	   kGL_POLYGON_STIPPLE_BIT/1,
	   kGL_PIXEL_MODE_BIT/1,
	   kGL_LIGHTING_BIT/1,
	   kGL_FOG_BIT/1,
	   kGL_DEPTH_BUFFER_BIT/1,
	   kGL_ACCUM_BUFFER_BIT/1,
	   kGL_STENCIL_BUFFER_BIT/1,
	   kGL_VIEWPORT_BIT/1,
	   kGL_TRANSFORM_BIT/1,
	   kGL_ENABLE_BIT/1,
	   kGL_COLOR_BUFFER_BIT/1,
	   kGL_HINT_BIT/1,
	   kGL_EVAL_BIT/1,
	   kGL_LIST_BIT/1,
	   kGL_TEXTURE_BIT/1,
	   kGL_SCISSOR_BIT/1,
	   kGL_ALL_ATTRIB_BITS/1,
	   kGL_POINTS/1,
	   kGL_LINES/1,
	   kGL_LINE_LOOP/1,
	   kGL_LINE_STRIP/1,
	   kGL_TRIANGLES/1,
	   kGL_TRIANGLE_STRIP/1,
	   kGL_TRIANGLE_FAN/1,
	   kGL_QUADS/1,
	   kGL_QUAD_STRIP/1,
	   kGL_POLYGON/1,
	   ...
	   kGL_ONE/1,
	   kGL_SRC_COLOR/1,
	   kGL_ONE_MINUS_SRC_COLOR/1,
	   kGL_SRC_ALPHA/1,
	   kGL_ONE_MINUS_SRC_ALPHA/1,
	   kGL_DST_ALPHA/1,
	   kGL_ONE_MINUS_DST_ALPHA/1,
	   kGL_DST_COLOR/1,
	   kGL_ONE_MINUS_DST_COLOR/1,
	   kGL_SRC_ALPHA_SATURATE/1,
	   kGL_FALSE/1,
	   kGL_TRUE/1,
	   kGL_CLIP_PLANE0/1,
	   kGL_CLIP_PLANE1/1,
	   ...
	   kGL_INVALID_ENUM/1,
	   kGL_INVALID_VALUE/1,
	   kGL_INVALID_OPERATION/1,
	   kGL_STACK_OVERFLOW/1,
	   kGL_STACK_UNDERFLOW/1,
	   kGL_OUT_OF_MEMORY/1,
	   kGL_2D/1,
	   kGL_3D/1,
	   kGL_3D_COLOR/1,
	   kGL_3D_COLOR_TEXTURE/1,
	   kGL_4D_COLOR_TEXTURE/1,
	   kGL_PASS_THROUGH_TOKEN/1,
	   kGL_POINT_TOKEN/1,
	   kGL_LINE_TOKEN/1,
	   kGL_POLYGON_TOKEN/1,
	   kGL_BITMAP_TOKEN/1,
	   kGL_DRAW_PIXEL_TOKEN/1,
	   kGL_COPY_PIXEL_TOKEN/1,
	   kGL_LINE_RESET_TOKEN/1,
	   kGL_EXP/1,
	   kGL_EXP2/1,
	   kGL_CW/1,
	   kGL_CCW/1,
	   ...
	   kGL_CURRENT_COLOR/1,
	   kGL_CURRENT_INDEX/1,
	   kGL_CURRENT_NORMAL/1,
	   kGL_CURRENT_TEXTURE_COORDS/1,
	   kGL_CURRENT_RASTER_COLOR/1,
	   kGL_CURRENT_RASTER_INDEX/1,
	   kGL_CURRENT_RASTER_TEXTURE_COORDS/1,
	   kGL_CURRENT_RASTER_POSITION/1,
	   kGL_CURRENT_RASTER_POSITION_VALID/1,
	   kGL_CURRENT_RASTER_DISTANCE/1,
	   kGL_POINT_SMOOTH/1,
	   kGL_POINT_SIZE/1,
	   kGL_POINT_SIZE_RANGE/1,
	   kGL_POINT_SIZE_GRANULARITY/1,
	   kGL_LINE_SMOOTH/1,
	   kGL_LINE_WIDTH/1,
	   kGL_LINE_WIDTH_RANGE/1,
	   kGL_LINE_WIDTH_GRANULARITY/1,
	   kGL_LINE_STIPPLE/1,
	   kGL_LINE_STIPPLE_PATTERN/1,
	   kGL_LINE_STIPPLE_REPEAT/1,
	   kGL_LIST_MODE/1,
	   kGL_MAX_LIST_NESTING/1,
	   kGL_LIST_BASE/1,
	   kGL_LIST_INDEX/1,
	   kGL_POLYGON_MODE/1,
	   kGL_POLYGON_SMOOTH/1,
	   kGL_POLYGON_STIPPLE/1,
	   kGL_EDGE_FLAG/1,
	   kGL_CULL_FACE/1,
	   kGL_CULL_FACE_MODE/1,
	   kGL_FRONT_FACE/1,
	   kGL_LIGHTING/1,
	   kGL_LIGHT_MODEL_LOCAL_VIEWER/1,
	   kGL_LIGHT_MODEL_TWO_SIDE/1,
	   kGL_LIGHT_MODEL_AMBIENT/1,
	   kGL_SHADE_MODEL/1,
	   kGL_COLOR_MATERIAL_FACE/1,
	   kGL_COLOR_MATERIAL_PARAMETER/1,
	   kGL_COLOR_MATERIAL/1,
	   kGL_FOG/1,
	   kGL_FOG_INDEX/1,
	   kGL_FOG_DENSITY/1,
	   kGL_FOG_START/1,
	   ...
	   kGL_DEPTH_RANGE/1,
	   kGL_DEPTH_TEST/1,
	   kGL_DEPTH_WRITEMASK/1,
	   kGL_DEPTH_CLEAR_VALUE/1,
	   kGL_DEPTH_FUNC/1,
	   kGL_ACCUM_CLEAR_VALUE/1,
	   kGL_STENCIL_TEST/1,
	   kGL_STENCIL_CLEAR_VALUE/1,
	   kGL_STENCIL_FUNC/1,
	   kGL_STENCIL_VALUE_MASK/1,
	   kGL_STENCIL_FAIL/1,
	   kGL_STENCIL_PASS_DEPTH_FAIL/1,
	   kGL_STENCIL_PASS_DEPTH_PASS/1,
	   kGL_STENCIL_REF/1,
	   kGL_STENCIL_WRITEMASK/1,
	   kGL_MATRIX_MODE/1,
	   kGL_NORMALIZE/1,
	   kGL_VIEWPORT/1,
	   kGL_MODELVIEW_STACK_DEPTH/1,
	   kGL_PROJECTION_STACK_DEPTH/1,
	   kGL_TEXTURE_STACK_DEPTH/1,
	   kGL_MODELVIEW_MATRIX/1,
	   kGL_PROJECTION_MATRIX/1,
	   kGL_TEXTURE_MATRIX/1,
	   kGL_ATTRIB_STACK_DEPTH/1,
	   kGL_CLIENT_ATTRIB_STACK_DEPTH/1,
	   kGL_ALPHA_TEST/1,
	   kGL_ALPHA_TEST_FUNC/1,
	   kGL_ALPHA_TEST_REF/1,
	   kGL_DITHER/1,
	   kGL_BLEND_DST/1,
	   kGL_BLEND_SRC/1,
	   kGL_BLEND/1,
	   kGL_LOGIC_OP_MODE/1,
	   kGL_INDEX_LOGIC_OP/1,
	   kGL_COLOR_LOGIC_OP/1,
	   kGL_AUX_BUFFERS/1,
	   kGL_DRAW_BUFFER/1,
	   kGL_READ_BUFFER/1,
	   kGL_SCISSOR_BOX/1,
	   kGL_SCISSOR_TEST/1,
	   kGL_INDEX_CLEAR_VALUE/1,
	   kGL_INDEX_WRITEMASK/1,
	   kGL_COLOR_CLEAR_VALUE/1,
	   kGL_COLOR_WRITEMASK/1,
	   kGL_INDEX_MODE/1,
	   kGL_RGBA_MODE/1,
	   kGL_DOUBLEBUFFER/1,
	   kGL_STEREO/1,
	   kGL_RENDER_MODE/1,
	   kGL_PERSPECTIVE_CORRECTION_HINT/1,
	   kGL_POINT_SMOOTH_HINT/1,
	   kGL_LINE_SMOOTH_HINT/1,
	   kGL_POLYGON_SMOOTH_HINT/1,
	   kGL_FOG_HINT/1,
	   kGL_TEXTURE_GEN_S/1,
	   kGL_TEXTURE_GEN_T/1,
	   kGL_TEXTURE_GEN_R/1,
	   kGL_TEXTURE_GEN_Q/1,
	   kGL_PIXEL_MAP_I_TO_I/1,
	   kGL_PIXEL_MAP_S_TO_S/1,
	   kGL_PIXEL_MAP_I_TO_R/1,
	   kGL_PIXEL_MAP_I_TO_G/1,
	   kGL_PIXEL_MAP_I_TO_B/1,
	   kGL_PIXEL_MAP_I_TO_A/1,
	   kGL_PIXEL_MAP_R_TO_R/1,
	   kGL_PIXEL_MAP_G_TO_G/1,
	   kGL_PIXEL_MAP_B_TO_B/1,
	   kGL_PIXEL_MAP_A_TO_A/1,
	   kGL_PIXEL_MAP_I_TO_I_SIZE/1,
	   kGL_PIXEL_MAP_S_TO_S_SIZE/1,
	   kGL_PIXEL_MAP_I_TO_R_SIZE/1,
	   kGL_PIXEL_MAP_I_TO_G_SIZE/1,
	   kGL_PIXEL_MAP_I_TO_B_SIZE/1,
	   kGL_PIXEL_MAP_I_TO_A_SIZE/1,
	   kGL_PIXEL_MAP_R_TO_R_SIZE/1,
	   kGL_PIXEL_MAP_G_TO_G_SIZE/1,
	   kGL_PIXEL_MAP_B_TO_B_SIZE/1,
	   kGL_PIXEL_MAP_A_TO_A_SIZE/1,
	   kGL_UNPACK_SWAP_BYTES/1,
	   kGL_UNPACK_LSB_FIRST/1,
	   kGL_UNPACK_ROW_LENGTH/1,
	   kGL_UNPACK_SKIP_ROWS/1,
	   kGL_UNPACK_SKIP_PIXELS/1,
	   kGL_UNPACK_ALIGNMENT/1,
	   kGL_PACK_SWAP_BYTES/1,
	   kGL_PACK_LSB_FIRST/1,
	   kGL_PACK_ROW_LENGTH/1,
	   kGL_PACK_SKIP_ROWS/1,
	   kGL_PACK_SKIP_PIXELS/1,
	   kGL_PACK_ALIGNMENT/1,
	   kGL_MAP_COLOR/1,
	   kGL_MAP_STENCIL/1,
	   kGL_INDEX_SHIFT/1,
	   kGL_INDEX_OFFSET/1,
	   ...
	   kGL_DEPTH_SCALE/1,
	   kGL_DEPTH_BIAS/1,
	   kGL_MAX_EVAL_ORDER/1,
	   kGL_MAX_LIGHTS/1,
	   kGL_MAX_CLIP_PLANES/1,
	   kGL_MAX_TEXTURE_SIZE/1,
	   kGL_MAX_PIXEL_MAP_TABLE/1,
	   kGL_MAX_ATTRIB_STACK_DEPTH/1,
	   kGL_MAX_MODELVIEW_STACK_DEPTH/1,
	   kGL_MAX_NAME_STACK_DEPTH/1,
	   kGL_MAX_PROJECTION_STACK_DEPTH/1,
	   kGL_MAX_TEXTURE_STACK_DEPTH/1,
	   kGL_MAX_VIEWPORT_DIMS/1,
	   kGL_MAX_CLIENT_ATTRIB_STACK_DEPTH/1,
	   kGL_SUBPIXEL_BITS/1,
	   kGL_INDEX_BITS/1,
	   kGL_RED_BITS/1,
	   kGL_GREEN_BITS/1,
	   ...
	   kGL_DEPTH_BITS/1,
	   kGL_STENCIL_BITS/1,
	   kGL_ACCUM_RED_BITS/1,
	   kGL_ACCUM_GREEN_BITS/1,
	   kGL_ACCUM_BLUE_BITS/1,
	   kGL_ACCUM_ALPHA_BITS/1,
	   kGL_NAME_STACK_DEPTH/1,
	   kGL_AUTO_NORMAL/1,
	   kGL_MAP1_COLOR_4/1,
	   kGL_MAP1_INDEX/1,
	   kGL_MAP1_NORMAL/1,
	   kGL_MAP1_TEXTURE_COORD_1/1,
	   kGL_MAP1_TEXTURE_COORD_2/1,
	   kGL_MAP1_TEXTURE_COORD_3/1,
	   kGL_MAP1_TEXTURE_COORD_4/1,
	   kGL_MAP1_VERTEX_3/1,
	   kGL_MAP1_VERTEX_4/1,
	   kGL_MAP2_COLOR_4/1,
	   kGL_MAP2_INDEX/1,
	   kGL_MAP2_NORMAL/1,
	   kGL_MAP2_TEXTURE_COORD_1/1,
	   kGL_MAP2_TEXTURE_COORD_2/1,
	   kGL_MAP2_TEXTURE_COORD_3/1,
	   kGL_MAP2_TEXTURE_COORD_4/1,
	   kGL_MAP2_VERTEX_3/1,
	   kGL_MAP2_VERTEX_4/1,
	   kGL_MAP1_GRID_DOMAIN/1,
	   kGL_MAP1_GRID_SEGMENTS/1,
	   kGL_MAP2_GRID_DOMAIN/1,
	   kGL_MAP2_GRID_SEGMENTS/1,
	   kGL_TEXTURE_1D/1,
	   kGL_TEXTURE_2D/1,
	   kGL_FEEDBACK_BUFFER_POINTER/1,
	   kGL_FEEDBACK_BUFFER_SIZE/1,
	   kGL_FEEDBACK_BUFFER_TYPE/1,
	   kGL_SELECTION_BUFFER_POINTER/1,
	   kGL_SELECTION_BUFFER_SIZE/1,
	   kGL_TEXTURE_WIDTH/1,
	   kGL_TEXTURE_HEIGHT/1,
	   kGL_TEXTURE_INTERNAL_FORMAT/1,
	   kGL_TEXTURE_BORDER_COLOR/1,
	   kGL_TEXTURE_BORDER/1,
	   kGL_DONT_CARE/1,
	   kGL_FASTEST/1,
	   kGL_NICEST/1,
	   kGL_LIGHT0/1,
	   ...
	   kGL_SPECULAR/1,
	   kGL_POSITION/1,
	   kGL_SPOT_DIRECTION/1,
	   kGL_SPOT_EXPONENT/1,
	   kGL_SPOT_CUTOFF/1,
	   kGL_CONSTANT_ATTENUATION/1,
	   kGL_LINEAR_ATTENUATION/1,
	   kGL_QUADRATIC_ATTENUATION/1,
	   kGL_COMPILE/1,
	   kGL_COMPILE_AND_EXECUTE/1,
	   kGL_CLEAR/1,
	   kGL_AND/1,
	   kGL_AND_REVERSE/1,
	   kGL_COPY/1,
	   ...
	   kGL_MODULATE/1,
	   kGL_DECAL/1,
	   kGL_TEXTURE_ENV_MODE/1,
	   kGL_TEXTURE_ENV_COLOR/1,
	   kGL_TEXTURE_ENV/1,
	   kGL_EYE_LINEAR/1,
	   kGL_OBJECT_LINEAR/1,
	   kGL_SPHERE_MAP/1,
	   kGL_TEXTURE_GEN_MODE/1,
	   kGL_OBJECT_PLANE/1,
	   kGL_EYE_PLANE/1,
	   kGL_NEAREST/1,
	   kGL_LINEAR/1,
	   kGL_NEAREST_MIPMAP_NEAREST/1,
	   kGL_LINEAR_MIPMAP_NEAREST/1,
	   kGL_NEAREST_MIPMAP_LINEAR/1,
	   kGL_LINEAR_MIPMAP_LINEAR/1,
	   kGL_TEXTURE_MAG_FILTER/1,
	   kGL_TEXTURE_MIN_FILTER/1,
	   kGL_TEXTURE_WRAP_S/1,
	   kGL_TEXTURE_WRAP_T/1,
	   kGL_CLAMP/1,
	   kGL_REPEAT/1,
	   kGL_CLIENT_PIXEL_STORE_BIT/1,
	   kGL_CLIENT_VERTEX_ARRAY_BIT/1,
	   kGL_CLIENT_ALL_ATTRIB_BITS/1,
	   kGL_POLYGON_OFFSET_FACTOR/1,
	   kGL_POLYGON_OFFSET_UNITS/1,
	   kGL_POLYGON_OFFSET_POINT/1,
	   kGL_POLYGON_OFFSET_LINE/1,
	   kGL_POLYGON_OFFSET_FILL/1,
	   kGL_ALPHA4/1,
	   kGL_ALPHA8/1,
	   kGL_ALPHA12/1,
	   kGL_ALPHA16/1,
	   ...
	   kGL_LUMINANCE12/1,
	   kGL_LUMINANCE16/1,
	   kGL_LUMINANCE4_ALPHA4/1,
	   kGL_LUMINANCE6_ALPHA2/1,
	   kGL_LUMINANCE8_ALPHA8/1,
	   kGL_LUMINANCE12_ALPHA4/1,
	   kGL_LUMINANCE12_ALPHA12/1,
	   kGL_LUMINANCE16_ALPHA16/1,
	   kGL_INTENSITY/1,
	   kGL_INTENSITY4/1,
	   kGL_INTENSITY8/1,
	   kGL_INTENSITY12/1,
	   ...
	   kGL_RGBA12/1,
	   kGL_RGBA16/1,
	   kGL_TEXTURE_RED_SIZE/1,
	   kGL_TEXTURE_GREEN_SIZE/1,
	   kGL_TEXTURE_BLUE_SIZE/1,
	   kGL_TEXTURE_ALPHA_SIZE/1,
	   kGL_TEXTURE_LUMINANCE_SIZE/1,
	   kGL_TEXTURE_INTENSITY_SIZE/1,
	   kGL_PROXY_TEXTURE_1D/1,
	   kGL_PROXY_TEXTURE_2D/1,
	   kGL_TEXTURE_PRIORITY/1,
	   kGL_TEXTURE_RESIDENT/1,
	   kGL_TEXTURE_BINDING_1D/1,
	   kGL_TEXTURE_BINDING_2D/1,
	   kGL_TEXTURE_BINDING_3D/1,
	   kGL_VERTEX_ARRAY/1,
	   kGL_NORMAL_ARRAY/1,
	   kGL_COLOR_ARRAY/1,
	   kGL_INDEX_ARRAY/1,
	   kGL_TEXTURE_COORD_ARRAY/1,
	   kGL_EDGE_FLAG_ARRAY/1,
	   kGL_VERTEX_ARRAY_SIZE/1,
	   kGL_VERTEX_ARRAY_TYPE/1,
	   kGL_VERTEX_ARRAY_STRIDE/1,
	   kGL_NORMAL_ARRAY_TYPE/1,
	   kGL_NORMAL_ARRAY_STRIDE/1,
	   kGL_COLOR_ARRAY_SIZE/1,
	   kGL_COLOR_ARRAY_TYPE/1,
	   kGL_COLOR_ARRAY_STRIDE/1,
	   kGL_INDEX_ARRAY_TYPE/1,
	   kGL_INDEX_ARRAY_STRIDE/1,
	   kGL_TEXTURE_COORD_ARRAY_SIZE/1,
	   kGL_TEXTURE_COORD_ARRAY_TYPE/1,
	   kGL_TEXTURE_COORD_ARRAY_STRIDE/1,
	   kGL_EDGE_FLAG_ARRAY_STRIDE/1,
	   kGL_VERTEX_ARRAY_POINTER/1,
	   kGL_NORMAL_ARRAY_POINTER/1,
	   kGL_COLOR_ARRAY_POINTER/1,
	   kGL_INDEX_ARRAY_POINTER/1,
	   kGL_TEXTURE_COORD_ARRAY_POINTER/1,
	   kGL_EDGE_FLAG_ARRAY_POINTER/1,
	   kGL_V2F/1,
	   kGL_V3F/1,
	   kGL_C4UB_V2F/1,
	   kGL_C4UB_V3F/1,
	   ...
	   kGL_T2F_C3F_V3F/1,
	   kGL_T2F_N3F_V3F/1,
	   kGL_T2F_C4F_N3F_V3F/1,
	   kGL_T4F_C4F_N3F_V4F/1,
	   kGL_BGR/1,
	   kGL_BGRA/1,
	   kGL_CONSTANT_COLOR/1,
	   kGL_ONE_MINUS_CONSTANT_COLOR/1,
	   kGL_CONSTANT_ALPHA/1,
	   kGL_ONE_MINUS_CONSTANT_ALPHA/1,
	   kGL_BLEND_COLOR/1,
	   kGL_FUNC_ADD/1,
	   kGL_MIN/1,
	   kGL_MAX/1,
	   kGL_BLEND_EQUATION/1,
	   kGL_BLEND_EQUATION_RGB/1,
	   kGL_BLEND_EQUATION_ALPHA/1,
	   kGL_FUNC_SUBTRACT/1,
	   kGL_FUNC_REVERSE_SUBTRACT/1,
	   kGL_COLOR_MATRIX/1,
	   kGL_COLOR_MATRIX_STACK_DEPTH/1,
	   kGL_MAX_COLOR_MATRIX_STACK_DEPTH/1,
	   kGL_POST_COLOR_MATRIX_RED_SCALE/1,
	   kGL_POST_COLOR_MATRIX_GREEN_SCALE/1,
	   kGL_POST_COLOR_MATRIX_BLUE_SCALE/1,
	   kGL_POST_COLOR_MATRIX_ALPHA_SCALE/1,
	   kGL_POST_COLOR_MATRIX_RED_BIAS/1,
	   kGL_POST_COLOR_MATRIX_GREEN_BIAS/1,
	   kGL_POST_COLOR_MATRIX_BLUE_BIAS/1,
	   kGL_POST_COLOR_MATRIX_ALPHA_BIAS/1,
	   kGL_COLOR_TABLE/1,
	   kGL_POST_CONVOLUTION_COLOR_TABLE/1,
	   kGL_POST_COLOR_MATRIX_COLOR_TABLE/1,
	   kGL_PROXY_COLOR_TABLE/1,
	   kGL_PROXY_POST_CONVOLUTION_COLOR_TABLE/1,
	   kGL_PROXY_POST_COLOR_MATRIX_COLOR_TABLE/1,
	   kGL_COLOR_TABLE_SCALE/1,
	   kGL_COLOR_TABLE_BIAS/1,
	   kGL_COLOR_TABLE_FORMAT/1,
	   kGL_COLOR_TABLE_WIDTH/1,
	   kGL_COLOR_TABLE_RED_SIZE/1,
	   kGL_COLOR_TABLE_GREEN_SIZE/1,
	   kGL_COLOR_TABLE_BLUE_SIZE/1,
	   kGL_COLOR_TABLE_ALPHA_SIZE/1,
	   kGL_COLOR_TABLE_LUMINANCE_SIZE/1,
	   kGL_COLOR_TABLE_INTENSITY_SIZE/1,
	   kGL_CONVOLUTION_1D/1,
	   kGL_CONVOLUTION_2D/1,
	   kGL_SEPARABLE_2D/1,
	   kGL_CONVOLUTION_BORDER_MODE/1,
	   kGL_CONVOLUTION_FILTER_SCALE/1,
	   kGL_CONVOLUTION_FILTER_BIAS/1,
	   kGL_REDUCE/1,
	   kGL_CONVOLUTION_FORMAT/1,
	   kGL_CONVOLUTION_WIDTH/1,
	   kGL_CONVOLUTION_HEIGHT/1,
	   kGL_MAX_CONVOLUTION_WIDTH/1,
	   kGL_MAX_CONVOLUTION_HEIGHT/1,
	   kGL_POST_CONVOLUTION_RED_SCALE/1,
	   kGL_POST_CONVOLUTION_GREEN_SCALE/1,
	   kGL_POST_CONVOLUTION_BLUE_SCALE/1,
	   kGL_POST_CONVOLUTION_ALPHA_SCALE/1,
	   kGL_POST_CONVOLUTION_RED_BIAS/1,
	   kGL_POST_CONVOLUTION_GREEN_BIAS/1,
	   kGL_POST_CONVOLUTION_BLUE_BIAS/1,
	   kGL_POST_CONVOLUTION_ALPHA_BIAS/1,
	   kGL_CONSTANT_BORDER/1,
	   kGL_REPLICATE_BORDER/1,
	   kGL_CONVOLUTION_BORDER_COLOR/1,
	   kGL_MAX_ELEMENTS_VERTICES/1,
	   kGL_MAX_ELEMENTS_INDICES/1,
	   kGL_HISTOGRAM/1,
	   kGL_PROXY_HISTOGRAM/1,
	   kGL_HISTOGRAM_WIDTH/1,
	   kGL_HISTOGRAM_FORMAT/1,
	   kGL_HISTOGRAM_RED_SIZE/1,
	   kGL_HISTOGRAM_GREEN_SIZE/1,
	   kGL_HISTOGRAM_BLUE_SIZE/1,
	   kGL_HISTOGRAM_ALPHA_SIZE/1,
	   kGL_HISTOGRAM_LUMINANCE_SIZE/1,
	   kGL_HISTOGRAM_SINK/1,
	   kGL_MINMAX/1,
	   kGL_MINMAX_FORMAT/1,
	   kGL_MINMAX_SINK/1,
	   kGL_TABLE_TOO_LARGE/1,
	   kGL_UNSIGNED_BYTE_3_3_2/1,
	   kGL_UNSIGNED_SHORT_4_4_4_4/1,
	   kGL_UNSIGNED_SHORT_5_5_5_1/1,
	   kGL_UNSIGNED_INT_8_8_8_8/1,
	   kGL_UNSIGNED_INT_10_10_10_2/1,
	   kGL_UNSIGNED_BYTE_2_3_3_REV/1,
	   kGL_UNSIGNED_SHORT_5_6_5/1,
	   kGL_UNSIGNED_SHORT_5_6_5_REV/1,
	   kGL_UNSIGNED_SHORT_4_4_4_4_REV/1,
	   kGL_UNSIGNED_SHORT_1_5_5_5_REV/1,
	   kGL_UNSIGNED_INT_8_8_8_8_REV/1,
	   kGL_UNSIGNED_INT_2_10_10_10_REV/1,
	   kGL_RESCALE_NORMAL/1,
	   kGL_LIGHT_MODEL_COLOR_CONTROL/1,
	   kGL_SINGLE_COLOR/1,
	   kGL_SEPARATE_SPECULAR_COLOR/1,
	   kGL_PACK_SKIP_IMAGES/1,
	   kGL_PACK_IMAGE_HEIGHT/1,
	   kGL_UNPACK_SKIP_IMAGES/1,
	   kGL_UNPACK_IMAGE_HEIGHT/1,
	   kGL_TEXTURE_3D/1,
	   kGL_PROXY_TEXTURE_3D/1,
	   kGL_TEXTURE_DEPTH/1,
	   kGL_TEXTURE_WRAP_R/1,
	   kGL_MAX_3D_TEXTURE_SIZE/1,
	   kGL_CLAMP_TO_EDGE/1,
	   kGL_CLAMP_TO_BORDER/1,
	   kGL_TEXTURE_MIN_LOD/1,
	   kGL_TEXTURE_MAX_LOD/1,
	   kGL_TEXTURE_BASE_LEVEL/1,
	   kGL_TEXTURE_MAX_LEVEL/1,
	   kGL_SMOOTH_POINT_SIZE_RANGE/1,
	   kGL_SMOOTH_POINT_SIZE_GRANULARITY/1,
	   kGL_SMOOTH_LINE_WIDTH_RANGE/1,
	   kGL_SMOOTH_LINE_WIDTH_GRANULARITY/1,
	   kGL_ALIASED_POINT_SIZE_RANGE/1,
	   kGL_ALIASED_LINE_WIDTH_RANGE/1,
	   kGL_TEXTURE0/1,
	   kGL_TEXTURE1/1,
	   kGL_TEXTURE2/1,
	   kGL_TEXTURE3/1,
	   ...
	   kGL_TEXTURE30/1,
	   kGL_TEXTURE31/1,
	   kGL_ACTIVE_TEXTURE/1,
	   kGL_CLIENT_ACTIVE_TEXTURE/1,
	   kGL_MAX_TEXTURE_UNITS/1,
	   kGL_COMBINE/1,
	   kGL_COMBINE_RGB/1,
	   kGL_COMBINE_ALPHA/1,
	   kGL_RGB_SCALE/1,
	   ...
	   kGL_SRC6_ALPHA/1,
	   kGL_SRC7_ALPHA/1,
	   kGL_QUERY_COUNTER_BITS/1,
	   kGL_CURRENT_QUERY/1,
	   kGL_QUERY_RESULT/1,
	   kGL_QUERY_RESULT_AVAILABLE/1,
	   kGL_SAMPLES_PASSED/1,
	   kGL_FOG_COORD_SRC/1,
	   kGL_FOG_COORD/1,
	   kGL_FRAGMENT_DEPTH/1,
	   kGL_CURRENT_FOG_COORD/1,
	   kGL_FOG_COORD_ARRAY_TYPE/1,
	   kGL_FOG_COORD_ARRAY_STRIDE/1,
	   kGL_FOG_COORD_ARRAY_POINTER/1,
	   kGL_FOG_COORD_ARRAY/1,
	   kGL_ARRAY_BUFFER/1,
	   kGL_ELEMENT_ARRAY_BUFFER/1,
	   kGL_ARRAY_BUFFER_BINDING/1,
	   kGL_ELEMENT_ARRAY_BUFFER_BINDING/1,
	   kGL_VERTEX_ARRAY_BUFFER_BINDING/1,
	   kGL_NORMAL_ARRAY_BUFFER_BINDING/1,
	   kGL_COLOR_ARRAY_BUFFER_BINDING/1,
	   kGL_INDEX_ARRAY_BUFFER_BINDING/1,
	   kGL_TEXTURE_COORD_ARRAY_BUFFER_BINDING/1,
	   kGL_EDGE_FLAG_ARRAY_BUFFER_BINDING/1,
	   kGL_SECONDARY_COLOR_ARRAY_BUFFER_BINDING/1,
	   kGL_FOG_COORD_ARRAY_BUFFER_BINDING/1,
	   kGL_WEIGHT_ARRAY_BUFFER_BINDING/1,
	   kGL_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING/1,
	   kGL_STREAM_DRAW/1,
	   kGL_STREAM_READ/1,
	   kGL_STREAM_COPY/1,
	   kGL_STATIC_DRAW/1,
	   ...
	   kGL_BUFFER_ACCESS/1,
	   kGL_BUFFER_MAPPED/1,
	   kGL_BUFFER_MAP_POINTER/1,
	   kGL_CURRENT_PROGRAM/1,
	   kGL_SHADER_TYPE/1,
	   kGL_DELETE_STATUS/1,
	   kGL_COMPILE_STATUS/1,
	   kGL_LINK_STATUS/1,
	   kGL_VALIDATE_STATUS/1,
	   kGL_INFO_LOG_LENGTH/1,
	   kGL_ATTACHED_SHADERS/1,
	   kGL_ACTIVE_UNIFORMS/1,
	   kGL_ACTIVE_UNIFORM_MAX_LENGTH/1,
	   kGL_SHADER_SOURCE_LENGTH/1,
	   kGL_FLOAT_VEC2/1,
	   kGL_FLOAT_VEC3/1,
	   kGL_FLOAT_VEC4/1,
	   kGL_INT_VEC2/1,
	   ...
	   kGL_SAMPLER_3D/1,
	   kGL_SAMPLER_CUBE/1,
	   kGL_SAMPLER_1D_SHADOW/1,
	   kGL_SAMPLER_2D_SHADOW/1,
	   kGL_SHADING_LANGUAGE_VERSION/1,
	   kGL_VERTEX_SHADER/1,
	   kGL_MAX_VERTEX_UNIFORM_COMPONENTS/1,
	   kGL_MAX_VARYING_FLOATS/1,
	   kGL_MAX_VERTEX_TEXTURE_IMAGE_UNITS/1,
	   kGL_MAX_COMBINED_TEXTURE_IMAGE_UNITS/1,
	   kGL_ACTIVE_ATTRIBUTES/1,
	   kGL_ACTIVE_ATTRIBUTE_MAX_LENGTH/1,
	   kGL_FRAGMENT_SHADER/1,
	   kGL_MAX_FRAGMENT_UNIFORM_COMPONENTS/1,
	   kGL_FRAGMENT_SHADER_DERIVATIVE_HINT/1,
	   kGL_MAX_VERTEX_ATTRIBS/1,
	   kGL_VERTEX_ATTRIB_ARRAY_ENABLED/1,
	   kGL_VERTEX_ATTRIB_ARRAY_SIZE/1,
	   kGL_VERTEX_ATTRIB_ARRAY_STRIDE/1,
	   kGL_VERTEX_ATTRIB_ARRAY_TYPE/1,
	   kGL_VERTEX_ATTRIB_ARRAY_NORMALIZED/1,
	   kGL_CURRENT_VERTEX_ATTRIB/1,
	   kGL_VERTEX_ATTRIB_ARRAY_POINTER/1,
	   kGL_VERTEX_PROGRAM_POINT_SIZE/1,
	   kGL_VERTEX_PROGRAM_TWO_SIDE/1,
	   kGL_MAX_TEXTURE_COORDS/1,
	   kGL_MAX_TEXTURE_IMAGE_UNITS/1,
	   kGL_MAX_DRAW_BUFFERS/1,
	   kGL_DRAW_BUFFER0/1,
	   kGL_DRAW_BUFFER1/1,
	   kGL_DRAW_BUFFER2/1,
	   kGL_DRAW_BUFFER3/1,
	   ...
	   kGL_POINT_SPRITE/1,
	   kGL_COORD_REPLACE/1,
	   kGL_POINT_SPRITE_COORD_ORIGIN/1,
	   kGL_LOWER_LEFT/1,
	   kGL_UPPER_LEFT/1,
	   kGL_STENCIL_BACK_FUNC/1,
	   kGL_STENCIL_BACK_VALUE_MASK/1,
	   kGL_STENCIL_BACK_REF/1,
	   kGL_STENCIL_BACK_FAIL/1,
	   kGL_STENCIL_BACK_PASS_DEPTH_FAIL/1,
	   kGL_STENCIL_BACK_PASS_DEPTH_PASS/1,
	   kGL_STENCIL_BACK_WRITEMASK/1,
	   kGL_CURRENT_RASTER_SECONDARY_COLOR/1,
	   kGL_PIXEL_PACK_BUFFER/1,
	   kGL_PIXEL_UNPACK_BUFFER/1,
	   kGL_PIXEL_PACK_BUFFER_BINDING/1,
	   kGL_PIXEL_UNPACK_BUFFER_BINDING/1,
	   kGL_FLOAT_MAT2x3/1,
	   kGL_FLOAT_MAT2x4/1,
	   kGL_FLOAT_MAT3x2/1,
	   kGL_FLOAT_MAT3x4/1,
	   ...
	   kGL_SRGB_ALPHA/1,
	   kGL_SRGB8_ALPHA8/1,
	   kGL_SLUMINANCE_ALPHA/1,
	   kGL_SLUMINANCE8_ALPHA8/1,
	   kGL_SLUMINANCE/1,
	   kGL_SLUMINANCE8/1,
	   kGL_COMPRESSED_SRGB/1,
	   kGL_COMPRESSED_SRGB_ALPHA/1,
	   kGL_COMPRESSED_SLUMINANCE/1,
	   kGL_COMPRESSED_SLUMINANCE_ALPHA/1
	  ]).
